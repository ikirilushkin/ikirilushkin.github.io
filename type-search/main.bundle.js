...
var github_1 = __webpack_require__(201);
var input = document.getElementById('input');
var repos = document.getElementById('repos');
var loading = document.getElementById('loading');
var inputTyping$ = rxjs_1.fromEvent(input, 'keyup').pipe(operators_1.map(function (event) { return event.target.value; }));
var req$ = inputTyping$.pipe(operators_1.filter(function (value) { return value.length > 2; }), operators_1.mergeMap(function (value) {
    loading.style.display = 'block';
    return github_1.findRepos(value);
}));
req$.pipe(operators_1.map(function (value) { return github_1.parse(value); })).subscribe(function (result) {
    console.log(repos);
    loading.style.display = 'none';
    showResult(repos, result.items);
});
function showResult(list, repos) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var TOKEN = 'e7fa239588f3c9711dbe2fc8f271982ce96c8144';
...
function parse(obj) {
    return {
        ...
        items: parseRepos(obj['items'])
    };
}
exports.parse = parse;
function parseRepos(items) {
    var repos = [];
